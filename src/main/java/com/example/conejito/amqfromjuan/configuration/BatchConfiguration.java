package com.example.conejito.amqfromjuan.configuration;


import com.example.conejito.amqfromjuan.amq.Producer;
import com.example.conejito.amqfromjuan.configuration.writers.RabbitBatchItemSenderWriter;
...
public class BatchConfiguration {
    ...
    @Bean
    public Step step1(RabbitBatchItemSenderWriter writer) {
